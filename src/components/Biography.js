    ...
    >
      <div className="col-span-1 row-span-1">
        <div className="hidden xl:flex items-center justify-center">
          <Typography
            variant="h3"
            className="pl-6 mt-6 text-4xl font-montserrat text-white font-bold text-center leading-tight"
          >
      ...
      <div className="bg-opacity-25 mt-3 rounded-lg py-0 px-4 md:px-6 md:col-span-3">
        <Typography className="text-justify md:text-justify text-base font-montserrat font-extralight text-white leading-9">
          ...
          knowledge by joining another academic internship in a company called
          "Softinsa" where i was a web developer using Agile Methodology, and
          later on joined them professionally for 9 months where i acquired more
