...
const Biography = () => {
  return (
     ...
     <div className="py-10 px-6 bg-primary md:grid grid-rows-6 grid-flow-col gap-2">
        ...
        <div className="bg-secondary bg-opacity-40 rounded-lg w-auto py-10 px-6 row-span-5 col-span-1 ">
...
Then, I joined a Higher Professional Technical Course that would lead me on to Computer Engineering. I participated in a partnership with the company called "Softinsa", from which I learned a lot because I had to keep in contact with it for hours. At the moment, I am professional intern.
        ...
        <div className="row-span-6 col-span-2 w-auto flex items-center justify-center">
        <img
      className="h-56 w-56 rounded-lg object-cover transition-all hover:scale-110"
